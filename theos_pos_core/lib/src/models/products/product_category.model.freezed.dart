...
@OdooId() int get id;@OdooString() String get name;@OdooString(odooName: 'complete_name') String? get completeName;@OdooMany2One('product.category', odooName: 'parent_id') int? get parentId;@OdooMany2OneName(sourceField: 'parent_id') String? get parentName;@OdooDateTime(odooName: 'write_date', writable: false) DateTime? get writeDate;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,completeName,parentId,parentName,writeDate);

@override
String toString() {
  return 'ProductCategory(id: $id, name: $name, completeName: $completeName, parentId: $parentId, parentName: $parentName, writeDate: $writeDate)';
}
...
@useResult
$Res call({
@OdooId() int id,@OdooString() String name,@OdooString(odooName: 'complete_name') String? completeName,@OdooMany2One('product.category', odooName: 'parent_id') int? parentId,@OdooMany2OneName(sourceField: 'parent_id') String? parentName,@OdooDateTime(odooName: 'write_date', writable: false) DateTime? writeDate
});
...
/// Create a copy of ProductCategory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? completeName = freezed,Object? parentId = freezed,Object? parentName = freezed,Object? writeDate = freezed,}) {
...
switch (_that) {
case _ProductCategory() when $default != null:
return $default(_that.id,_that.name,_that.completeName,_that.parentId,_that.parentName,_that.writeDate);case _:
  return orElse();
...
/// Create a copy of ProductCategory
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? completeName = freezed,Object? parentId = freezed,Object? parentName = freezed,Object? writeDate = freezed,}) {
