...
@OdooFloat(odooName: 'amount_cash') double get amountCash;@OdooLocalOnly() double get amountUnpaid;@OdooFloat(odooName: 'total_cost_amount') double get totalCostAmount;@OdooFloat(odooName: 'margin') double get margin;@OdooFloat(odooName: 'margin_percent') double get marginPercent;@OdooFloat(odooName: 'retenido_amount') double get retenidoAmount;// Approvals (l10n_ec_sale_credit)
