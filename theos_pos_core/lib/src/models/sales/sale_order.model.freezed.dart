...
@OdooMany2One('res.partner', odooName: 'partner_id') int? get partnerId;@OdooMany2OneName(sourceField: 'partner_id') String? get partnerName;@OdooLocalOnly() String? get partnerVat;@OdooLocalOnly() String? get partnerStreet;@OdooLocalOnly() String? get partnerPhone;@OdooLocalOnly() String? get partnerEmail;@OdooLocalOnly() String? get partnerAvatar;@OdooMany2One('res.partner', odooName: 'partner_invoice_id') int? get partnerInvoiceId;@OdooMany2OneName(sourceField: 'partner_invoice_id') String? get partnerInvoiceAddress;@OdooMany2One('res.partner', odooName: 'partner_shipping_id') int? get partnerShippingId;@OdooMany2OneName(sourceField: 'partner_shipping_id') String? get partnerShippingAddress;// Vendedor y equipo
...
// Campo custom l10n_ec_collection_box — requiere módulo instalado
@OdooBoolean(odooName: 'is_credit') bool get isCredit;@OdooMany2One('account.fiscal.position', odooName: 'fiscal_position_id') int? get fiscalPositionId;@OdooMany2OneName(sourceField: 'fiscal_position_id') String? get fiscalPositionName;// Montos — campos computados por Odoo (readonly)
@OdooFloat(odooName: 'amount_untaxed', writable: false) double get amountUntaxed;@OdooFloat(odooName: 'amount_tax', writable: false) double get amountTax;@OdooFloat(odooName: 'amount_total', writable: false) double get amountTotal;@OdooFloat(odooName: 'amount_to_invoice', writable: false) double get amountToInvoice;@OdooFloat(odooName: 'amount_invoiced', writable: false) double get amountInvoiced;// Estado de facturacion — campos computados por Odoo (readonly)
@OdooSelection(odooName: 'invoice_status', writable: false) InvoiceStatus get invoiceStatus;@OdooInteger(odooName: 'invoice_count', writable: false) int get invoiceCount;// Notas y referencias
...
@OdooLocalOnly() bool get requirePayment;@OdooFloat(odooName: 'prepayment_percent') double get prepaymentPercent;// Control — campos computados por Odoo (readonly)
@OdooBoolean(odooName: 'locked', writable: false) bool get locked;@OdooBoolean(odooName: 'is_expired', writable: false) bool get isExpired;// Descuentos (l10n_ec_sale_discount)
...
@OdooFloat(odooName: 'amount_cash') double get amountCash;@OdooLocalOnly() double get amountUnpaid;@OdooFloat(odooName: 'total_cost_amount') double get totalCostAmount;@OdooFloat(odooName: 'margin', writable: false) double get margin;@OdooFloat(odooName: 'margin_percent', writable: false) double get marginPercent;@OdooFloat(odooName: 'retenido_amount') double get retenidoAmount;// Approvals (l10n_ec_sale_credit)
...
@override@OdooLocalOnly() final  String? partnerAvatar;
...
@override@JsonKey()@OdooFloat(odooName: 'amount_untaxed', writable: false) final  double amountUntaxed;
@override@JsonKey()@OdooFloat(odooName: 'amount_tax', writable: false) final  double amountTax;
@override@JsonKey()@OdooFloat(odooName: 'amount_total', writable: false) final  double amountTotal;
@override@JsonKey()@OdooFloat(odooName: 'amount_to_invoice', writable: false) final  double amountToInvoice;
@override@JsonKey()@OdooFloat(odooName: 'amount_invoiced', writable: false) final  double amountInvoiced;
// Estado de facturacion — campos computados por Odoo (readonly)
@override@JsonKey()@OdooSelection(odooName: 'invoice_status', writable: false) final  InvoiceStatus invoiceStatus;
@override@JsonKey()@OdooInteger(odooName: 'invoice_count', writable: false) final  int invoiceCount;
// Notas y referencias
...
// Odoo 19.5 (erp1): 'require_payment' ya no existe en sale.order del
// servidor (smoke fields_get, julio 2026).
@override@JsonKey()@OdooLocalOnly() final  bool requirePayment;
...
@override@JsonKey()@OdooBoolean(odooName: 'locked', writable: false) final  bool locked;
@override@JsonKey()@OdooBoolean(odooName: 'is_expired', writable: false) final  bool isExpired;
...
@override@JsonKey()@OdooLocalOnly() final  double amountUnpaid;
@override@JsonKey()@OdooFloat(odooName: 'total_cost_amount') final  double totalCostAmount;
@override@JsonKey()@OdooFloat(odooName: 'margin', writable: false) final  double margin;
@override@JsonKey()@OdooFloat(odooName: 'margin_percent', writable: false) final  double marginPercent;
