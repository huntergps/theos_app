...
_Advance _$AdvanceFromJson(Map<String, dynamic> json) => _Advance(
  ...
  amountUsed: (json['amountUsed'] as num?)?.toDouble() ?? 0.0,
  amountAvailable: (json['amountAvailable'] as num?)?.toDouble() ?? 0.0,
  amountReturned: (json['amountReturned'] as num?)?.toDouble() ?? 0.0,
