...
class QwebReportTemplate extends Table {
  ...
  TextColumn get templateKey =>
      text().unique()(); // Unique identifier for caching
  ...
  BoolColumn get attachmentUse =>
      boolean().withDefault(const Constant(false))();
  TextColumn get paperformatId => text().nullable()();
  TextColumn get xmlContent => text()(); // QWeb template XML/HTML
  TextColumn get requiredFields =>
      text().nullable()(); // JSON array of required fields
  TextColumn get dependencies =>
      text().nullable()(); // JSON array of template dependencies
  DateTimeColumn get lastSynced =>
      dateTime().nullable()(); // Last sync timestamp
  TextColumn get checksum =>
      text().nullable()(); // MD5/SHA checksum for change detection
...
class QwebPaperFormat extends Table {
  ...
  TextColumn get orientation =>
      text().withDefault(const Constant('portrait'))(); // portrait, landscape
