...
@useResult
$Res call({
@OdooId() int id,@OdooLocalOnly() String? lineUuid,@OdooMany2One('sale.order', odooName: 'order_id') int orderId,@OdooInteger() int sequence,@OdooSelection(odooName: 'display_type') LineDisplayType displayType,@OdooBoolean(odooName: 'is_downpayment') bool isDownpayment,@OdooMany2One('product.product', odooName: 'product_id') int? productId,@OdooMany2OneName(sourceField: 'product_id') String? productName,@OdooLocalOnly() String? productCode,@OdooMany2One('product.template', odooName: 'product_template_id') int? productTemplateId,@OdooMany2OneName(sourceField: 'product_template_id') String? productTemplateName,@OdooLocalOnly() String? productType,@OdooLocalOnly() int? categId,@OdooLocalOnly() String? categName,@OdooString() String name,@OdooFloat(odooName: 'product_uom_qty') double productUomQty,@OdooMany2One('uom.uom', odooName: 'product_uom_id') int? productUomId,@OdooMany2OneName(sourceField: 'product_uom_id') String? productUomName,@OdooFloat(odooName: 'price_unit') double priceUnit,@OdooFloat() double discount,@OdooFloat(odooName: 'discount_amount') double discountAmount,@OdooFloat(odooName: 'price_subtotal') double priceSubtotal,@OdooFloat(odooName: 'price_tax') double priceTax,@OdooFloat(odooName: 'price_total') double priceTotal,@OdooFloat(odooName: 'price_reduce_taxexcl') double priceReduce,@OdooLocalOnly() String? taxIds,@OdooLocalOnly() String? taxNames,@OdooFloat(odooName: 'qty_delivered') double qtyDelivered,@OdooFloat(odooName: 'customer_lead') double customerLead,@OdooFloat(odooName: 'qty_invoiced') double qtyInvoiced,@OdooFloat(odooName: 'qty_to_invoice') double qtyToInvoice,@OdooSelection(odooName: 'invoice_status') LineInvoiceStatus invoiceStatus,@OdooString(odooName: 'state') String? orderState,@OdooBoolean(odooName: 'collapse_prices') bool collapsePrices,@OdooBoolean(odooName: 'collapse_composition') bool collapseComposition,@OdooBoolean(odooName: 'is_optional') bool isOptional,@OdooLocalOnly() bool isSynced,@OdooLocalOnly() DateTime? lastSyncDate,@OdooDateTime(odooName: 'write_date', writable: false) DateTime? writeDate,@OdooLocalOnly() bool isUnitProduct
});
...
class _SaleOrderLine extends SaleOrderLine {
  const _SaleOrderLine({@OdooId() required this.id, @OdooLocalOnly() this.lineUuid, @OdooMany2One('sale.order', odooName: 'order_id') required this.orderId, @OdooInteger() this.sequence = 10, @OdooSelection(odooName: 'display_type') this.displayType = LineDisplayType.product, @OdooBoolean(odooName: 'is_downpayment') this.isDownpayment = false, @OdooMany2One('product.product', odooName: 'product_id') this.productId, @OdooMany2OneName(sourceField: 'product_id') this.productName, @OdooLocalOnly() this.productCode, @OdooMany2One('product.template', odooName: 'product_template_id') this.productTemplateId, @OdooMany2OneName(sourceField: 'product_template_id') this.productTemplateName, @OdooLocalOnly() this.productType, @OdooLocalOnly() this.categId, @OdooLocalOnly() this.categName, @OdooString() required this.name, @OdooFloat(odooName: 'product_uom_qty') this.productUomQty = 1.0, @OdooMany2One('uom.uom', odooName: 'product_uom_id') this.productUomId, @OdooMany2OneName(sourceField: 'product_uom_id') this.productUomName, @OdooFloat(odooName: 'price_unit') this.priceUnit = 0.0, @OdooFloat() this.discount = 0.0, @OdooFloat(odooName: 'discount_amount') this.discountAmount = 0.0, @OdooFloat(odooName: 'price_subtotal') this.priceSubtotal = 0.0, @OdooFloat(odooName: 'price_tax') this.priceTax = 0.0, @OdooFloat(odooName: 'price_total') this.priceTotal = 0.0, @OdooFloat(odooName: 'price_reduce_taxexcl') this.priceReduce = 0.0, @OdooLocalOnly() this.taxIds, @OdooLocalOnly() this.taxNames, @OdooFloat(odooName: 'qty_delivered') this.qtyDelivered = 0.0, @OdooFloat(odooName: 'customer_lead') this.customerLead = 0.0, @OdooFloat(odooName: 'qty_invoiced') this.qtyInvoiced = 0.0, @OdooFloat(odooName: 'qty_to_invoice') this.qtyToInvoice = 0.0, @OdooSelection(odooName: 'invoice_status') this.invoiceStatus = LineInvoiceStatus.no, @OdooString(odooName: 'state') this.orderState, @OdooBoolean(odooName: 'collapse_prices') this.collapsePrices = false, @OdooBoolean(odooName: 'collapse_composition') this.collapseComposition = false, @OdooBoolean(odooName: 'is_optional') this.isOptional = false, @OdooLocalOnly() this.isSynced = false, @OdooLocalOnly() this.lastSyncDate, @OdooDateTime(odooName: 'write_date', writable: false) this.writeDate, @OdooLocalOnly() this.isUnitProduct = true}): super._();
