...
@OdooId() int get id;@OdooString() String get name;@OdooString() String get code;@OdooBoolean() bool get active;@OdooMany2One('res.company', odooName: 'company_id') int? get companyId;@OdooMany2OneName(sourceField: 'company_id') String? get companyName;@OdooMany2One('account.journal', odooName: 'journal_id') int? get journalId;@OdooMany2OneName(sourceField: 'journal_id') String? get journalName;@OdooMany2One('account.journal', odooName: 'cash_journal_id') int? get cashJournalId;@OdooMany2OneName(sourceField: 'cash_journal_id') String? get cashJournalName;@OdooMany2Many('account.journal', odooName: 'allowed_journal_ids') List<int> get allowedJournalIds;@OdooMany2One('account.account', odooName: 'cash_difference_account_id') int? get cashDifferenceAccountId;@OdooMany2One('res.currency', odooName: 'currency_id') int? get currencyId;@OdooMany2OneName(sourceField: 'currency_id') String? get currencyName;@OdooBoolean(odooName: 'set_maximum_difference') bool get setMaximumDifference;@OdooFloat(odooName: 'amount_authorized_diff') double get amountAuthorizedDiff;@OdooMany2Many('res.users', odooName: 'user_ids') List<int>? get userIds;@OdooLocalOnly() String? get posAppCapabilitiesJson;@OdooMany2One('collection.session', odooName: 'current_session_id') int? get currentSessionId;@OdooSelection(odooName: 'current_session_state') String? get currentSessionState;@OdooString(odooName: 'current_session_name') String? get currentSessionName;@OdooInteger(odooName: 'number_of_opened_session') int get numberOfOpenedSession;@OdooDateTime(odooName: 'last_session_closing_date') DateTime? get lastSessionClosingDate;@OdooFloat(odooName: 'last_session_closing_cash') double get lastSessionClosingCash;@OdooString(odooName: 'collection_session_username') String? get currentSessionUserName;@OdooString(odooName: 'current_session_state_display') String? get currentSessionStateDisplay;@OdooInteger(odooName: 'number_of_rescue_session') int get numberOfRescueSession;
...
as String?,allowedJournalIds: null == allowedJournalIds ? _self.allowedJournalIds : allowedJournalIds // ignore: cast_nullable_to_non_nullable
...
as List<int>?,posAppCapabilitiesJson: freezed == posAppCapabilitiesJson ? _self.posAppCapabilitiesJson : posAppCapabilitiesJson // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey()@OdooMany2Many('account.journal', odooName: 'allowed_journal_ids') List<int> get allowedJournalIds {
  if (_allowedJournalIds is EqualUnmodifiableListView) return _allowedJournalIds;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_allowedJournalIds);
}
...
@override@OdooLocalOnly() final  String? posAppCapabilitiesJson;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,code,active,companyId,companyName,journalId,journalName,cashJournalId,cashJournalName,const DeepCollectionEquality().hash(_allowedJournalIds),cashDifferenceAccountId,currencyId,currencyName,setMaximumDifference,amountAuthorizedDiff,const DeepCollectionEquality().hash(_userIds),posAppCapabilitiesJson,currentSessionId,currentSessionState,currentSessionName,numberOfOpenedSession,lastSessionClosingDate,lastSessionClosingCash,currentSessionUserName,currentSessionStateDisplay,numberOfRescueSession]);
...
as String?,cashJournalId: freezed == cashJournalId ? _self.cashJournalId : cashJournalId // ignore: cast_nullable_to_non_nullable
as int?,cashJournalName: freezed == cashJournalName ? _self.cashJournalName : cashJournalName // ignore: cast_nullable_to_non_nullable
as String?,allowedJournalIds: null == allowedJournalIds ? _self._allowedJournalIds : allowedJournalIds // ignore: cast_nullable_to_non_nullable
as List<int>,cashDifferenceAccountId: freezed == cashDifferenceAccountId ? _self.cashDifferenceAccountId : cashDifferenceAccountId // ignore: cast_nullable_to_non_nullable
as int?,currencyId: freezed == currencyId ? _self.currencyId : currencyId // ignore: cast_nullable_to_non_nullable
as int?,currencyName: freezed == currencyName ? _self.currencyName : currencyName // ignore: cast_nullable_to_non_nullable
as String?,setMaximumDifference: null == setMaximumDifference ? _self.setMaximumDifference : setMaximumDifference // ignore: cast_nullable_to_non_nullable
