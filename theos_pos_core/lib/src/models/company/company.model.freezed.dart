...
@OdooMany2OneName(sourceField: 'sale_discount_product_id') String? get saleDiscountProductName;/// Default partner for new sales
...
@OdooLocalOnly(driftName: 'warehouseId') int? get defaultWarehouseId;@OdooLocalOnly() String? get defaultWarehouseName;/// Default pricelist for new sales
@OdooLocalOnly() int? get defaultPricelistId;@OdooLocalOnly() String? get defaultPricelistName;/// Default payment term for new sales
@OdooLocalOnly() int? get defaultPaymentTermId;@OdooLocalOnly() String? get defaultPaymentTermName;/// Whether to require end customer data in sales.
@OdooBoolean(odooName: 'pedir_datos_consumidor_final', driftName: 'pedirEndCustomerData') bool get pedirEndCustomerData;/// Whether to require sales referrer
...
@OdooLocalOnly() double? get saleCustomerInvoiceLimitSri;/// Maximum discount percentage allowed
@OdooFloat(odooName: 'max_discount_percentage') double get maxDiscountPercentage;/// Overdue days threshold for credit blocking
...
@OdooLocalOnly() double get creditOfflineSafetyMargin;/// Maximum age in hours for credit data to be considered valid
@OdooLocalOnly() int get creditDataMaxAgeHours;/// Days before a reservation expires
@OdooInteger(odooName: 'reservation_expiry_days') int get reservationExpiryDays;/// Optional local warehouse preference for reservations.
@OdooLocalOnly() int? get reservationWarehouseId;/// Warehouse name for reservations
@OdooLocalOnly() String? get reservationWarehouseName;/// Location for reservations
...
@OdooBoolean(odooName: 'reserve_from_quotation') bool get reserveFromQuotation;@OdooDateTime(odooName: 'write_date', writable: false) DateTime? get writeDate;
...
@override@OdooLocalOnly(driftName: 'warehouseId') final  int? defaultWarehouseId;
@override@OdooLocalOnly() final  String? defaultWarehouseName;
/// Default pricelist for new sales
@override@OdooLocalOnly() final  int? defaultPricelistId;
@override@OdooLocalOnly() final  String? defaultPricelistName;
/// Default payment term for new sales
@override@OdooLocalOnly() final  int? defaultPaymentTermId;
@override@OdooLocalOnly() final  String? defaultPaymentTermName;
/// Whether to require end customer data in sales.
@override@JsonKey()@OdooBoolean(odooName: 'pedir_datos_consumidor_final', driftName: 'pedirEndCustomerData') final  bool pedirEndCustomerData;
...
@override@OdooLocalOnly() final  double? saleCustomerInvoiceLimitSri;
...
@override@JsonKey()@OdooLocalOnly() final  double creditOfflineSafetyMargin;
/// Maximum age in hours for credit data to be considered valid
@override@JsonKey()@OdooLocalOnly() final  int creditDataMaxAgeHours;
...
@override@OdooLocalOnly() final  int? reservationWarehouseId;
/// Warehouse name for reservations
@override@OdooLocalOnly() final  String? reservationWarehouseName;
