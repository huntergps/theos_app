...
const _$SaleOrderStateEnumMap = {
  ...
  SaleOrderState.waitingApproval: 'waiting',
...
class SaleOrderManager extends OdooModelManager<SaleOrder>
  ...
  static SaleOrder fromOdooMap(Map<String, dynamic> data) {
    return SaleOrder(
      ...
      entregarSoloPagado: parseOdooBool(data['exige_pago_total_entrega']),
  ...
  Map<String, dynamic> toOdoo(SaleOrder record) {
    return {
      ...
      'exige_pago_total_entrega': record.entregarSoloPagado,
  ...
  SaleOrder fromDrift(dynamic row) {
    return SaleOrder(
      ...
      amountUnpaid: row.amountUnpaid as double? ?? 0.0,
  ...
  static const Map<String, String> fieldMappings = {
    ...
    'exige_pago_total_entrega': 'entregarSoloPagado',
