...
/// Create a copy of Advance
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? advanceUuid = freezed,Object? name = freezed,Object? date = null,Object? dateEstimated = freezed,Object? dateDue = freezed,Object? state = null,Object? advanceType = null,Object? partnerId = null,Object? partnerName = freezed,Object? reference = null,Object? amount = null,Object? amountUsed = null,Object? amountAvailable = null,Object? amountReturned = null,Object? usagePercentage = null,Object? daysToExpire = freezed,Object? isExpired = null,Object? collectionSessionId = freezed,Object? saleOrderId = freezed,Object? lines = null,}) {
...
as DateTime,dateEstimated: freezed == dateEstimated ? _self.dateEstimated : dateEstimated // ignore: cast_nullable_to_non_nullable
...
class _Advance extends Advance {
  const _Advance({@OdooId() this.id = 0, @OdooLocalOnly() this.advanceUuid, @OdooString() this.name, @OdooDate() required this.date, @OdooDate(odooName: 'date_estimated') this.dateEstimated, @OdooDate(odooName: 'date_due') this.dateDue, @OdooSelection() this.state = AdvanceState.draft, @OdooSelection(odooName: 'advance_type') required this.advanceType, @OdooMany2One('res.partner', odooName: 'partner_id') required this.partnerId, @OdooMany2OneName(sourceField: 'partner_id') this.partnerName, @OdooString() required this.reference, @OdooFloat() this.amount = 0.0, @OdooFloat(odooName: 'amount_used') this.amountUsed = 0.0, @OdooFloat(odooName: 'amount_available') this.amountAvailable = 0.0, @OdooFloat(odooName: 'amount_returned') this.amountReturned = 0.0, @OdooFloat(odooName: 'usage_percentage') this.usagePercentage = 0.0, @OdooInteger(odooName: 'days_to_expire') this.daysToExpire, @OdooBoolean(odooName: 'is_expired') this.isExpired = false, @OdooMany2One('collection.session', odooName: 'collection_session_id') this.collectionSessionId, @OdooMany2One('sale.order', odooName: 'sale_order_id') this.saleOrderId, @OdooLocalOnly()  List<AdvanceLine> lines = const []}): _lines = lines,super._();
...
/// Create a copy of Advance
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? advanceUuid = freezed,Object? name = freezed,Object? date = null,Object? dateEstimated = freezed,Object? dateDue = freezed,Object? state = null,Object? advanceType = null,Object? partnerId = null,Object? partnerName = freezed,Object? reference = null,Object? amount = null,Object? amountUsed = null,Object? amountAvailable = null,Object? amountReturned = null,Object? usagePercentage = null,Object? daysToExpire = freezed,Object? isExpired = null,Object? collectionSessionId = freezed,Object? saleOrderId = freezed,Object? lines = null,}) {
...
@OdooId() int get id;@OdooLocalOnly() String? get lineUuid;@OdooLocalOnly() int? get advanceId;@OdooMany2One('account.journal', odooName: 'journal_id') int get journalId;@OdooMany2OneName(sourceField: 'journal_id') String? get journalName;@OdooLocalOnly() String? get journalType;@OdooMany2One('account.advance.method.line', odooName: 'advance_method_line_id') int? get advanceMethodLineId;@OdooMany2OneName(sourceField: 'advance_method_line_id') String? get advanceMethodName;@OdooFloat() double get amount;@OdooString(odooName: 'nro_document') String? get documentNumber;@OdooDate(odooName: 'date_document') DateTime? get documentDate;@OdooMany2One('res.partner.bank', odooName: 'partner_bank_id') int? get partnerBankId;@OdooMany2OneName(sourceField: 'partner_bank_id') String? get partnerBankName;@OdooDate(odooName: 'check_due_date') DateTime? get checkDueDate;@OdooMany2One('account.card.brand', odooName: 'card_brand_id') int? get cardBrandId;@OdooMany2OneName(sourceField: 'card_brand_id') String? get cardBrandName;@OdooMany2One('account.card.deadline', odooName: 'card_deadline_id') int? get cardDeadlineId;@OdooMany2OneName(sourceField: 'card_deadline_id') String? get cardDeadlineName;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,lineUuid,advanceId,journalId,journalName,journalType,advanceMethodLineId,advanceMethodName,amount,documentNumber,documentDate,partnerBankId,partnerBankName,checkDueDate,cardBrandId,cardBrandName,cardDeadlineId,cardDeadlineName);

@override
String toString() {
  return 'AdvanceLine(id: $id, lineUuid: $lineUuid, advanceId: $advanceId, journalId: $journalId, journalName: $journalName, journalType: $journalType, advanceMethodLineId: $advanceMethodLineId, advanceMethodName: $advanceMethodName, amount: $amount, documentNumber: $documentNumber, documentDate: $documentDate, partnerBankId: $partnerBankId, partnerBankName: $partnerBankName, checkDueDate: $checkDueDate, cardBrandId: $cardBrandId, cardBrandName: $cardBrandName, cardDeadlineId: $cardDeadlineId, cardDeadlineName: $cardDeadlineName)';
}
...
@useResult
$Res call({
@OdooId() int id,@OdooLocalOnly() String? lineUuid,@OdooLocalOnly() int? advanceId,@OdooMany2One('account.journal', odooName: 'journal_id') int journalId,@OdooMany2OneName(sourceField: 'journal_id') String? journalName,@OdooLocalOnly() String? journalType,@OdooMany2One('account.advance.method.line', odooName: 'advance_method_line_id') int? advanceMethodLineId,@OdooMany2OneName(sourceField: 'advance_method_line_id') String? advanceMethodName,@OdooFloat() double amount,@OdooString(odooName: 'nro_document') String? documentNumber,@OdooDate(odooName: 'date_document') DateTime? documentDate,@OdooMany2One('res.partner.bank', odooName: 'partner_bank_id') int? partnerBankId,@OdooMany2OneName(sourceField: 'partner_bank_id') String? partnerBankName,@OdooDate(odooName: 'check_due_date') DateTime? checkDueDate,@OdooMany2One('account.card.brand', odooName: 'card_brand_id') int? cardBrandId,@OdooMany2OneName(sourceField: 'card_brand_id') String? cardBrandName,@OdooMany2One('account.card.deadline', odooName: 'card_deadline_id') int? cardDeadlineId,@OdooMany2OneName(sourceField: 'card_deadline_id') String? cardDeadlineName
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@OdooId()  int id, @OdooLocalOnly()  String? lineUuid, @OdooLocalOnly()  int? advanceId, @OdooMany2One('account.journal', odooName: 'journal_id')  int journalId, @OdooMany2OneName(sourceField: 'journal_id')  String? journalName, @OdooLocalOnly()  String? journalType, @OdooMany2One('account.advance.method.line', odooName: 'advance_method_line_id')  int? advanceMethodLineId, @OdooMany2OneName(sourceField: 'advance_method_line_id')  String? advanceMethodName, @OdooFloat()  double amount, @OdooString(odooName: 'nro_document')  String? documentNumber, @OdooDate(odooName: 'date_document')  DateTime? documentDate, @OdooMany2One('res.partner.bank', odooName: 'partner_bank_id')  int? partnerBankId, @OdooMany2OneName(sourceField: 'partner_bank_id')  String? partnerBankName, @OdooDate(odooName: 'check_due_date')  DateTime? checkDueDate, @OdooMany2One('account.card.brand', odooName: 'card_brand_id')  int? cardBrandId, @OdooMany2OneName(sourceField: 'card_brand_id')  String? cardBrandName, @OdooMany2One('account.card.deadline', odooName: 'card_deadline_id')  int? cardDeadlineId, @OdooMany2OneName(sourceField: 'card_deadline_id')  String? cardDeadlineName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AdvanceLine() when $default != null:
return $default(_that.id,_that.lineUuid,_that.advanceId,_that.journalId,_that.journalName,_that.journalType,_that.advanceMethodLineId,_that.advanceMethodName,_that.amount,_that.documentNumber,_that.documentDate,_that.partnerBankId,_that.partnerBankName,_that.checkDueDate,_that.cardBrandId,_that.cardBrandName,_that.cardDeadlineId,_that.cardDeadlineName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@OdooId()  int id, @OdooLocalOnly()  String? lineUuid, @OdooLocalOnly()  int? advanceId, @OdooMany2One('account.journal', odooName: 'journal_id')  int journalId, @OdooMany2OneName(sourceField: 'journal_id')  String? journalName, @OdooLocalOnly()  String? journalType, @OdooMany2One('account.advance.method.line', odooName: 'advance_method_line_id')  int? advanceMethodLineId, @OdooMany2OneName(sourceField: 'advance_method_line_id')  String? advanceMethodName, @OdooFloat()  double amount, @OdooString(odooName: 'nro_document')  String? documentNumber, @OdooDate(odooName: 'date_document')  DateTime? documentDate, @OdooMany2One('res.partner.bank', odooName: 'partner_bank_id')  int? partnerBankId, @OdooMany2OneName(sourceField: 'partner_bank_id')  String? partnerBankName, @OdooDate(odooName: 'check_due_date')  DateTime? checkDueDate, @OdooMany2One('account.card.brand', odooName: 'card_brand_id')  int? cardBrandId, @OdooMany2OneName(sourceField: 'card_brand_id')  String? cardBrandName, @OdooMany2One('account.card.deadline', odooName: 'card_deadline_id')  int? cardDeadlineId, @OdooMany2OneName(sourceField: 'card_deadline_id')  String? cardDeadlineName)  $default,) {final _that = this;
switch (_that) {
case _AdvanceLine():
return $default(_that.id,_that.lineUuid,_that.advanceId,_that.journalId,_that.journalName,_that.journalType,_that.advanceMethodLineId,_that.advanceMethodName,_that.amount,_that.documentNumber,_that.documentDate,_that.partnerBankId,_that.partnerBankName,_that.checkDueDate,_that.cardBrandId,_that.cardBrandName,_that.cardDeadlineId,_that.cardDeadlineName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@OdooId()  int id, @OdooLocalOnly()  String? lineUuid, @OdooLocalOnly()  int? advanceId, @OdooMany2One('account.journal', odooName: 'journal_id')  int journalId, @OdooMany2OneName(sourceField: 'journal_id')  String? journalName, @OdooLocalOnly()  String? journalType, @OdooMany2One('account.advance.method.line', odooName: 'advance_method_line_id')  int? advanceMethodLineId, @OdooMany2OneName(sourceField: 'advance_method_line_id')  String? advanceMethodName, @OdooFloat()  double amount, @OdooString(odooName: 'nro_document')  String? documentNumber, @OdooDate(odooName: 'date_document')  DateTime? documentDate, @OdooMany2One('res.partner.bank', odooName: 'partner_bank_id')  int? partnerBankId, @OdooMany2OneName(sourceField: 'partner_bank_id')  String? partnerBankName, @OdooDate(odooName: 'check_due_date')  DateTime? checkDueDate, @OdooMany2One('account.card.brand', odooName: 'card_brand_id')  int? cardBrandId, @OdooMany2OneName(sourceField: 'card_brand_id')  String? cardBrandName, @OdooMany2One('account.card.deadline', odooName: 'card_deadline_id')  int? cardDeadlineId, @OdooMany2OneName(sourceField: 'card_deadline_id')  String? cardDeadlineName)?  $default,) {final _that = this;
switch (_that) {
case _AdvanceLine() when $default != null:
return $default(_that.id,_that.lineUuid,_that.advanceId,_that.journalId,_that.journalName,_that.journalType,_that.advanceMethodLineId,_that.advanceMethodName,_that.amount,_that.documentNumber,_that.documentDate,_that.partnerBankId,_that.partnerBankName,_that.checkDueDate,_that.cardBrandId,_that.cardBrandName,_that.cardDeadlineId,_that.cardDeadlineName);case _:
  return null;
...
class _AdvanceLine extends AdvanceLine {
  const _AdvanceLine({@OdooId() this.id = 0, @OdooLocalOnly() this.lineUuid, @OdooLocalOnly() this.advanceId, @OdooMany2One('account.journal', odooName: 'journal_id') required this.journalId, @OdooMany2OneName(sourceField: 'journal_id') this.journalName, @OdooLocalOnly() this.journalType, @OdooMany2One('account.advance.method.line', odooName: 'advance_method_line_id') this.advanceMethodLineId, @OdooMany2OneName(sourceField: 'advance_method_line_id') this.advanceMethodName, @OdooFloat() required this.amount, @OdooString(odooName: 'nro_document') this.documentNumber, @OdooDate(odooName: 'date_document') this.documentDate, @OdooMany2One('res.partner.bank', odooName: 'partner_bank_id') this.partnerBankId, @OdooMany2OneName(sourceField: 'partner_bank_id') this.partnerBankName, @OdooDate(odooName: 'check_due_date') this.checkDueDate, @OdooMany2One('account.card.brand', odooName: 'card_brand_id') this.cardBrandId, @OdooMany2OneName(sourceField: 'card_brand_id') this.cardBrandName, @OdooMany2One('account.card.deadline', odooName: 'card_deadline_id') this.cardDeadlineId, @OdooMany2OneName(sourceField: 'card_deadline_id') this.cardDeadlineName}): super._();
...
@override@OdooLocalOnly() final  int? advanceId;
...
/// Create a copy of AdvanceLine
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? lineUuid = freezed,Object? advanceId = freezed,Object? journalId = null,Object? journalName = freezed,Object? journalType = freezed,Object? advanceMethodLineId = freezed,Object? advanceMethodName = freezed,Object? amount = null,Object? documentNumber = freezed,Object? documentDate = freezed,Object? partnerBankId = freezed,Object? partnerBankName = freezed,Object? checkDueDate = freezed,Object? cardBrandId = freezed,Object? cardBrandName = freezed,Object? cardDeadlineId = freezed,Object? cardDeadlineName = freezed,}) {
