...
@OdooBoolean(odooName: 'require_payment') bool get requirePayment;@OdooFloat(odooName: 'prepayment_percent') double get prepaymentPercent;// Control — campos computados por Odoo (readonly)
