...
@OdooId() int get id;@OdooString() String get name;@OdooString() String get login;@OdooString() String? get email;@OdooString() String? get lang;@OdooString() String? get tz;@OdooString() String? get signature;@OdooMany2One('res.partner', odooName: 'partner_id') int? get partnerId;@OdooMany2OneName(sourceField: 'partner_id') String? get partnerName;@OdooMany2One('res.company', odooName: 'company_id') int? get companyId;@OdooMany2OneName(sourceField: 'company_id') String? get companyName;@OdooMany2One('stock.warehouse', odooName: 'property_warehouse_id') int? get warehouseId;@OdooMany2OneName(sourceField: 'property_warehouse_id') String? get warehouseName;@OdooString(odooName: 'avatar_128') String? get avatar128;@OdooString(odooName: 'notification_type') String? get notificationType;@OdooLocalOnly() String? get workEmail;@OdooLocalOnly() String? get workPhone;@OdooLocalOnly() String? get mobilePhone;@OdooLocalOnly() List<int> get groupIds;@OdooLocalOnly() List<String> get permissions;@OdooLocalOnly() bool get isCurrentUser;@OdooDateTime(odooName: 'write_date') DateTime? get writeDate;// Out of Office (modulo mail)
...
@OdooString(odooName: 'calendar_default_privacy') String? get calendarDefaultPrivacy;// Work location (modulo hr) — requiere módulo hr instalado
@OdooLocalOnly() int? get workLocationId;// Requiere módulo hr instalado
@OdooLocalOnly() String? get workLocationName;// Resource calendar / Work schedule — requiere módulo hr instalado
@OdooLocalOnly() int? get resourceCalendarId;// Requiere módulo hr instalado
@OdooLocalOnly() String? get resourceCalendarName;// PIN for attendance — requiere módulo hr instalado
@OdooLocalOnly() String? get pin;// Private information — requiere módulo hr instalado
@OdooLocalOnly() String? get privateStreet;@OdooLocalOnly() String? get privateStreet2;@OdooLocalOnly() String? get privateCity;@OdooLocalOnly() String? get privateZip;@OdooLocalOnly() int? get privateStateId;@OdooLocalOnly() String? get privateStateName;@OdooLocalOnly() int? get privateCountryId;@OdooLocalOnly() String? get privateCountryName;@OdooLocalOnly() String? get privateEmail;@OdooLocalOnly() String? get privatePhone;// Emergency contact — requiere módulo hr instalado
@OdooLocalOnly() String? get emergencyContact;@OdooLocalOnly() String? get emergencyPhone;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@OdooId()  int id, @OdooString()  String name, @OdooString()  String login, @OdooString()  String? email, @OdooString()  String? lang, @OdooString()  String? tz, @OdooString()  String? signature, @OdooMany2One('res.partner', odooName: 'partner_id')  int? partnerId, @OdooMany2OneName(sourceField: 'partner_id')  String? partnerName, @OdooMany2One('res.company', odooName: 'company_id')  int? companyId, @OdooMany2OneName(sourceField: 'company_id')  String? companyName, @OdooMany2One('stock.warehouse', odooName: 'property_warehouse_id')  int? warehouseId, @OdooMany2OneName(sourceField: 'property_warehouse_id')  String? warehouseName, @OdooString(odooName: 'avatar_128')  String? avatar128, @OdooString(odooName: 'notification_type')  String? notificationType, @OdooLocalOnly()  String? workEmail, @OdooLocalOnly()  String? workPhone, @OdooLocalOnly()  String? mobilePhone, @OdooLocalOnly()  List<int> groupIds, @OdooLocalOnly()  List<String> permissions, @OdooLocalOnly()  bool isCurrentUser, @OdooDateTime(odooName: 'write_date')  DateTime? writeDate, @OdooDateTime(odooName: 'out_of_office_from')  DateTime? outOfOfficeFrom, @OdooDateTime(odooName: 'out_of_office_to')  DateTime? outOfOfficeTo, @OdooString(odooName: 'out_of_office_message')  String? outOfOfficeMessage, @OdooString(odooName: 'calendar_default_privacy')  String? calendarDefaultPrivacy, @OdooLocalOnly()  int? workLocationId, @OdooLocalOnly()  String? workLocationName, @OdooLocalOnly()  int? resourceCalendarId, @OdooLocalOnly()  String? resourceCalendarName, @OdooLocalOnly()  String? pin, @OdooLocalOnly()  String? privateStreet, @OdooLocalOnly()  String? privateStreet2, @OdooLocalOnly()  String? privateCity, @OdooLocalOnly()  String? privateZip, @OdooLocalOnly()  int? privateStateId, @OdooLocalOnly()  String? privateStateName, @OdooLocalOnly()  int? privateCountryId, @OdooLocalOnly()  String? privateCountryName, @OdooLocalOnly()  String? privateEmail, @OdooLocalOnly()  String? privatePhone, @OdooLocalOnly()  String? emergencyContact, @OdooLocalOnly()  String? emergencyPhone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@OdooId()  int id, @OdooString()  String name, @OdooString()  String login, @OdooString()  String? email, @OdooString()  String? lang, @OdooString()  String? tz, @OdooString()  String? signature, @OdooMany2One('res.partner', odooName: 'partner_id')  int? partnerId, @OdooMany2OneName(sourceField: 'partner_id')  String? partnerName, @OdooMany2One('res.company', odooName: 'company_id')  int? companyId, @OdooMany2OneName(sourceField: 'company_id')  String? companyName, @OdooMany2One('stock.warehouse', odooName: 'property_warehouse_id')  int? warehouseId, @OdooMany2OneName(sourceField: 'property_warehouse_id')  String? warehouseName, @OdooString(odooName: 'avatar_128')  String? avatar128, @OdooString(odooName: 'notification_type')  String? notificationType, @OdooLocalOnly()  String? workEmail, @OdooLocalOnly()  String? workPhone, @OdooLocalOnly()  String? mobilePhone, @OdooLocalOnly()  List<int> groupIds, @OdooLocalOnly()  List<String> permissions, @OdooLocalOnly()  bool isCurrentUser, @OdooDateTime(odooName: 'write_date')  DateTime? writeDate, @OdooDateTime(odooName: 'out_of_office_from')  DateTime? outOfOfficeFrom, @OdooDateTime(odooName: 'out_of_office_to')  DateTime? outOfOfficeTo, @OdooString(odooName: 'out_of_office_message')  String? outOfOfficeMessage, @OdooString(odooName: 'calendar_default_privacy')  String? calendarDefaultPrivacy, @OdooLocalOnly()  int? workLocationId, @OdooLocalOnly()  String? workLocationName, @OdooLocalOnly()  int? resourceCalendarId, @OdooLocalOnly()  String? resourceCalendarName, @OdooLocalOnly()  String? pin, @OdooLocalOnly()  String? privateStreet, @OdooLocalOnly()  String? privateStreet2, @OdooLocalOnly()  String? privateCity, @OdooLocalOnly()  String? privateZip, @OdooLocalOnly()  int? privateStateId, @OdooLocalOnly()  String? privateStateName, @OdooLocalOnly()  int? privateCountryId, @OdooLocalOnly()  String? privateCountryName, @OdooLocalOnly()  String? privateEmail, @OdooLocalOnly()  String? privatePhone, @OdooLocalOnly()  String? emergencyContact, @OdooLocalOnly()  String? emergencyPhone)  $default,) {final _that = this;
switch (_that) {
case _User():
return $default(_that.id,_that.name,_that.login,_that.email,_that.lang,_that.tz,_that.signature,_that.partnerId,_that.partnerName,_that.companyId,_that.companyName,_that.warehouseId,_that.warehouseName,_that.avatar128,_that.notificationType,_that.workEmail,_that.workPhone,_that.mobilePhone,_that.groupIds,_that.permissions,_that.isCurrentUser,_that.writeDate,_that.outOfOfficeFrom,_that.outOfOfficeTo,_that.outOfOfficeMessage,_that.calendarDefaultPrivacy,_that.workLocationId,_that.workLocationName,_that.resourceCalendarId,_that.resourceCalendarName,_that.pin,_that.privateStreet,_that.privateStreet2,_that.privateCity,_that.privateZip,_that.privateStateId,_that.privateStateName,_that.privateCountryId,_that.privateCountryName,_that.privateEmail,_that.privatePhone,_that.emergencyContact,_that.emergencyPhone);case _:
  throw StateError('Unexpected subclass');
...
class _User extends User {
  const _User({@OdooId() required this.id, @OdooString() required this.name, @OdooString() required this.login, @OdooString() this.email, @OdooString() this.lang, @OdooString() this.tz, @OdooString() this.signature, @OdooMany2One('res.partner', odooName: 'partner_id') this.partnerId, @OdooMany2OneName(sourceField: 'partner_id') this.partnerName, @OdooMany2One('res.company', odooName: 'company_id') this.companyId, @OdooMany2OneName(sourceField: 'company_id') this.companyName, @OdooMany2One('stock.warehouse', odooName: 'property_warehouse_id') this.warehouseId, @OdooMany2OneName(sourceField: 'property_warehouse_id') this.warehouseName, @OdooString(odooName: 'avatar_128') this.avatar128, @OdooString(odooName: 'notification_type') this.notificationType, @OdooLocalOnly() this.workEmail, @OdooLocalOnly() this.workPhone, @OdooLocalOnly() this.mobilePhone, @OdooLocalOnly() final  List<int> groupIds = const [], @OdooLocalOnly() final  List<String> permissions = const [], @OdooLocalOnly() this.isCurrentUser = false, @OdooDateTime(odooName: 'write_date') this.writeDate, @OdooDateTime(odooName: 'out_of_office_from') this.outOfOfficeFrom, @OdooDateTime(odooName: 'out_of_office_to') this.outOfOfficeTo, @OdooString(odooName: 'out_of_office_message') this.outOfOfficeMessage, @OdooString(odooName: 'calendar_default_privacy') this.calendarDefaultPrivacy, @OdooLocalOnly() this.workLocationId, @OdooLocalOnly() this.workLocationName, @OdooLocalOnly() this.resourceCalendarId, @OdooLocalOnly() this.resourceCalendarName, @OdooLocalOnly() this.pin, @OdooLocalOnly() this.privateStreet, @OdooLocalOnly() this.privateStreet2, @OdooLocalOnly() this.privateCity, @OdooLocalOnly() this.privateZip, @OdooLocalOnly() this.privateStateId, @OdooLocalOnly() this.privateStateName, @OdooLocalOnly() this.privateCountryId, @OdooLocalOnly() this.privateCountryName, @OdooLocalOnly() this.privateEmail, @OdooLocalOnly() this.privatePhone, @OdooLocalOnly() this.emergencyContact, @OdooLocalOnly() this.emergencyPhone}): _groupIds = groupIds,_permissions = permissions,super._();
...
@override@OdooLocalOnly() final  String? pin;
// Private information — requiere módulo hr instalado
@override@OdooLocalOnly() final  String? privateStreet;
@override@OdooLocalOnly() final  String? privateStreet2;
@override@OdooLocalOnly() final  String? privateCity;
@override@OdooLocalOnly() final  String? privateZip;
@override@OdooLocalOnly() final  int? privateStateId;
@override@OdooLocalOnly() final  String? privateStateName;
@override@OdooLocalOnly() final  int? privateCountryId;
@override@OdooLocalOnly() final  String? privateCountryName;
@override@OdooLocalOnly() final  String? privateEmail;
@override@OdooLocalOnly() final  String? privatePhone;
// Emergency contact — requiere módulo hr instalado
@override@OdooLocalOnly() final  String? emergencyContact;
@override@OdooLocalOnly() final  String? emergencyPhone;
