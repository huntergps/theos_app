...
@OdooId() int get id;@OdooLocalOnly() String? get lineUuid;@OdooMany2One('account.journal', odooName: 'journal_id') int get journalId;@OdooMany2OneName(sourceField: 'journal_id') String? get journalName;@OdooString(odooName: 'journal_type') String? get journalType;@OdooMany2One('account.advance.method.line', odooName: 'advance_method_line_id') int? get advanceMethodLineId;@OdooMany2OneName(sourceField: 'advance_method_line_id') String? get advanceMethodName;@OdooFloat() double get amount;@OdooString(odooName: 'nro_document') String? get documentNumber;@OdooDate(odooName: 'date_document') DateTime? get documentDate;@OdooMany2One('res.partner.bank', odooName: 'partner_bank_id') int? get partnerBankId;@OdooMany2OneName(sourceField: 'partner_bank_id') String? get partnerBankName;@OdooDate(odooName: 'check_due_date') DateTime? get checkDueDate;@OdooMany2One('account.card.brand', odooName: 'card_brand_id') int? get cardBrandId;@OdooMany2OneName(sourceField: 'card_brand_id') String? get cardBrandName;@OdooMany2One('account.card.deadline', odooName: 'card_deadline_id') int? get cardDeadlineId;@OdooMany2OneName(sourceField: 'card_deadline_id') String? get cardDeadlineName;
