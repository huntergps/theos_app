...
void main() {
  ...
  group('SaleOrderStateExtension - fromString', () {
    test('parses English state names', () {
      expect(
        SaleOrderStateExtension.fromString('draft'),
        equals(SaleOrderState.draft),
      );
      expect(
        SaleOrderStateExtension.fromString('sent'),
        equals(SaleOrderState.sent),
      );
      expect(
        SaleOrderStateExtension.fromString('sale'),
        equals(SaleOrderState.sale),
      );
      expect(
        SaleOrderStateExtension.fromString('cancel'),
        equals(SaleOrderState.cancel),
      );
      expect(
        SaleOrderStateExtension.fromString('done'),
        equals(SaleOrderState.done),
      );
      expect(
        SaleOrderStateExtension.fromString('approved'),
        equals(SaleOrderState.approved),
      );
      expect(
        SaleOrderStateExtension.fromString('rejected'),
        equals(SaleOrderState.rejected),
      );
    });

    test('parses Spanish state names', () {
      expect(
        SaleOrderStateExtension.fromString('cotización'),
        equals(SaleOrderState.draft),
      );
      expect(
        SaleOrderStateExtension.fromString('cotizacion'),
        equals(SaleOrderState.draft),
      );
      expect(
        SaleOrderStateExtension.fromString('enviado'),
        equals(SaleOrderState.sent),
      );
      expect(
        SaleOrderStateExtension.fromString('cancelado'),
        equals(SaleOrderState.cancel),
      );
      expect(
      ...
      expect(
        SaleOrderStateExtension.fromString('rechazado'),
        equals(SaleOrderState.rejected),
      );
    });

    test('parses the canonical waiting state', () {
      expect(
        SaleOrderStateExtension.fromString('waiting'),
        equals(SaleOrderState.waitingApproval),
      );
      expect(
        SaleOrderStateExtension.fromString('esperando aprobación'),
        equals(SaleOrderState.waitingApproval),
      );
    });
    ...
    test('null defaults to draft', () {
      expect(
        SaleOrderStateExtension.fromString(null),
        equals(SaleOrderState.draft),
      );
    });
    ...
    test('false defaults to draft', () {
      expect(
        SaleOrderStateExtension.fromString(false),
        equals(SaleOrderState.draft),
      );
    });
    ...
    test('unknown string defaults to draft', () {
      expect(
        SaleOrderStateExtension.fromString('unknown_state'),
        equals(SaleOrderState.draft),
      );
    });
    ...
    test('roundtrip: toOdooString -> fromString', () {
      for (final state in SaleOrderState.values) {
        ...
        expect(
          parsed,
          equals(state),
          reason: '$state -> "$odooStr" should roundtrip',
        );
      }
    });
  });
