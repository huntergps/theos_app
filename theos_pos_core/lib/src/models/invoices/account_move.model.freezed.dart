...
@OdooMany2One('res.partner', odooName: 'partner_id') int? get partnerId;@OdooMany2OneName(sourceField: 'partner_id') String? get partnerName;@OdooString(odooName: 'partner_vat') String? get partnerVat;@OdooLocalOnly() String? get partnerStreet;@OdooLocalOnly() String? get partnerCity;@OdooLocalOnly() String? get partnerPhone;@OdooLocalOnly() String? get partnerEmail;// ============ Journal ============
