...
class AccountPaymentManager extends OdooModelManager<AccountPayment>
  ...
  /// Por eso su tear-off (`AccountPaymentManager.fromOdooMap`) es transferible a
  ...
  @override
  AccountPayment fromOdoo(Map<String, dynamic> data) => fromOdooMap(data);
  ...
  AccountPayment fromDrift(dynamic row) {
    return AccountPayment(
      ...
      isCashPayment: row.isCashPayment as bool? ?? false,
  ...
  dynamic createDriftCompanion(AccountPayment record) {
    return RawValuesInsertable({
      ...
      'payment_method_line_name': driftVar<String>(
      ...
      'card_last4': driftVar<String>(record.cardLast4),
  ...
  AccountPayment applyWebSocketChangesToRecord(
    ...
    updated = updated.copyWith(
      ...
      isCashPayment: record.isCashPayment,
      ref: record.ref,
